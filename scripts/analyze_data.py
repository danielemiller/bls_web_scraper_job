...
logging.basicConfig(filename="/home/astro/shared/projects/bls_scraping_data_job/logs/analyze_data.log", level=logging.INFO, format="%(asctime)s %(message)s", datefmt="%m/%d/%Y %I:%M:%S %p")
    ...
    try:
        ...
        for file in os.listdir(f"/home/astro/shared/projects/bls_scraping_data_job/analysis/{folder_name}"):
            if file.endswith(".zip"):
                ...
                # Save the analysis results as a .txt file in the /reports directory
                with open(f"/home/astro/shared/projects/bls_scraping_data_job/analysis/{folder_name}/{file}_analysis.txt",
